...
function saveData(data) {
    localStorage.setItem('todoData', JSON.stringify(TodoApp.data));
}
...
TodoApp.onAdded = task => saveData(TodoApp);
TodoApp.onDeleted = id => saveData(TodoApp);
TodoApp.onStatusChanged = id => saveData(TodoApp);
